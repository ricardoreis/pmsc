...
-- Tempo de Geração: Set 09, 2013 as 05:05 PM
-- Versão do Servidor: 5.0.95
-- Versão do PHP: 5.2.6
-- 
-- Banco de Dados: `pmscs`
-- 
CREATE DATABASE `pmscs` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pmscs`;
