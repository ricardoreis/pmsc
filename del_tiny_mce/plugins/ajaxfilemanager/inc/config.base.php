...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../imagens/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../imagens/');	//accept relative path only
	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name 
	define("CONFIG_SYS_DIR_SESSION_PATH", dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'session' . DIRECTORY_SEPARATOR);
	...
	define('CONFIG_UPLOAD_MAXSIZE', 2048 * 1024 ); //by bytes
	...
	define('CONFIG_EDITABLE_VALID_EXTS', '');
